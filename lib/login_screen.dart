...
import 'package:newprojectfirebase/features/widgets/spin_kit.dart'; // make sure this contains backdropFilter
        ...
        child: BlocConsumer<AuthBloc, AuthState>(
          listener: (context, state) {
            ...
            if (state is AuthLoadedState) {
              ...
              Navigator.pushReplacementNamed(context, Routes.addPlaceRoute);
          ...
          builder: (context, state) {
            return Stack(
              children: [
                ...
                // ---------------- Loader Overlay ----------------
                if (_isLoading) backdropFilter(context),
              ],
            );
          },
        ),
